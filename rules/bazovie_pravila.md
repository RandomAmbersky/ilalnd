...
1. первый игрок берет один **очко** из **пула повреждений** и назначает его на одного из юнитов второго игрока
1. второй игрок совершает **защитные действия** ( напр.блок щитом) пытаясь избежать урона, в случае успеха переходим к шагу 2.
