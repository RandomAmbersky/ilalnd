...
1. пока в **пуле повреждений** есть очки, первый игрок берет **1HP**  из него и назначает выбранноего на одного из юнитов второго игрока
1. второй игрок совершает **защитные действия** ( напр.блок щитом) пытаясь избежать урона, в случае успеха переходим к шагу 3.
