...
2. первый игрок совершает **атакующие** действия своим выбранным юнитом, определяя максимально возможный урон (**"пул повреждений"**)
...
3. уничтоженные **технические** юниты убираются с поля боя ( вместе с уничтоженными в них **пехотными** юнитами и их **предметами** ), уничтоженные **пехотные** юниты и их **предметы** остаются на поле боя
